...
- [x] Track the ownership of resources within the semantic analyzer.
- [x] Automatically insert code to deallocate (drop) resources when their owner goes out of scope.
...
- [x] Prevent returning references to local variables.
- [ ] Implement lifetime analysis to prevent dangling references in other scenarios (e.g., assigning a short-lived reference to a longer-lived variable).
